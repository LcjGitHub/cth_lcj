...
import com.chetuhui.lcj.chezhubao.tool.AppTool;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.tv_registered_code:
                if (isonclick){
                    if (!TextUtils.isEmpty(mEtRegisteredPh.getText())){
            ...
            case R.id.tv_registered_wancheng:
                    ...
                    if (TextUtils.isEmpty(mEtRegisteredPh.getText())||TextUtils.isEmpty(mEtRegisteredPw.getText())
                            ||TextUtils.isEmpty(mEtRegisteredCode.getText())){
