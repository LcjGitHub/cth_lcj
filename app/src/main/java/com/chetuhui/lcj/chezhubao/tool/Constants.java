package com.chetuhui.lcj.chezhubao.tool;
...
public class Constants {
    ...
    public static String WECHAT_APPID="wxc031836e034bda16";
    public static String WECHAT_SECRET="a575ec13ce6ffd0ae4722270e52b1f20";



    public final static int FAST_CLICK_TIME = 100;
    // 两次点击按钮之间的点击间隔不能少于1000毫秒
    public final static int MIN_CLICK_DELAY_TIME = 1000;
    ...
    //默认保存下载文件目录
    public static final String DOWNLOAD_DIR = FileTool.getRootPath() + File.separator + "Download" + File.separator + DeviceTool.getAppPackageName() + File.separator;

    //图片缓存路径
    public static final String PICTURE_CACHE_PATH = FileTool.getCacheFolder(BaseTool.getContext()) + File.separator + "Picture" + File.separator + "Cache" + File.separator;

    //图片原始路径
    public static final String PICTURE_ORIGIN_PATH = FileTool.getRootPath() + File.separator + DeviceTool.getAppPackageName() + File.separator + "Picture" + File.separator + "Origin" + File.separator;

    //图片压缩路径
    public static final String PICTURE_COMPRESS_PATH = FileTool.getRootPath() + File.separator + DeviceTool.getAppPackageName() + File.separator + "Picture" + File.separator + "Compress" + File.separator;

    //默认导出文件目录
    public static final String EXPORT_FILE_PATH = FileTool.getRootPath() + File.separator + DeviceTool.getAppPackageName() + File.separator + "ExportFile" + File.separator;

    //图片名称
    public static final String getPictureName() {
        return TimeTool.getCurrentDateTime(DATE_FORMAT_LINK) + "_" + new Random().nextInt(1000) + ".jpg";
    }
