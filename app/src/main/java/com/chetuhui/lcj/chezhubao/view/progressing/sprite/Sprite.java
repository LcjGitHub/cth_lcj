package com.chetuhui.lcj.chezhubao.view.progressing.sprite;
...
public abstract class Sprite extends Drawable implements
    ...
    @Override
    public void start() {
        if (AnimationTool.isStarted(animator)) {
            return;
        }
    ...
    public boolean isRunning() {
        return AnimationTool.isRunning(animator);
    }
