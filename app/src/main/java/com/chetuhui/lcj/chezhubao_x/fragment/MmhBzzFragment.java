...
public class MmhBzzFragment extends Fragment {
...
private ImageView iv_amc_sqt;
    ...
    int num=1;
    private MyHandler mHandler =new MyHandler(MmhBzzFragment.this);

    private static class MyHandler extends Handler {
            private WeakReference<MmhBzzFragment> activityWeakReference;

            public MyHandler(MmhBzzFragment activity) {
                activityWeakReference = new WeakReference<MmhBzzFragment>(activity);
            }

            @Override
            public void handleMessage(Message msg) {
                MmhBzzFragment activity = activityWeakReference.get();
                if (activity != null) {
    ...
    public static MmhBzzFragment newInstance() {
        MmhBzzFragment fragment = new MmhBzzFragment();
        return fragment;
    }
    ...
    private void getN_mutualAidEvent(String num,String code) {
        ...
        OkGo.<String>get(NetData.N_findMyMutualbills+"?pageSize=10&pageNum="+num+"&type=2&carNum="+code)
                .tag(this)
