...
public class ChangephoneActivity extends ActivityBase implements View.OnClickListener {
   ...
   private MyHandler mMyHandler=new MyHandler(ChangephoneActivity.this);
    ...
    private void initView() {
        mTitlebarAccount = (CommonTitleBar) findViewById(R.id.titlebar_changephone);
        ...
        mTvChangephXysjh.setText("现有手机号："+SPTool.getString(ChangephoneActivity.this,"phone"));
                    ...
                    public void onSuccess(com.lzy.okgo.model.Response<String> response) {
                        ...
                        try {
                            ...
                            if (code==0){
                                ...
                                SPTool.remove(ChangephoneActivity.this,"token");
