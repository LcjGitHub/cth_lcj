...
import com.chetuhui.lcj.chezhubao_x.view.dialog.wheel.DateArrayAdapter;
import com.chetuhui.lcj.chezhubao_x.view.dialog.wheel.NumericWheelAdapter;
import com.chetuhui.lcj.chezhubao_x.view.dialog.wheel.OnWheelChangedListener;
import com.chetuhui.lcj.chezhubao_x.view.dialog.wheel.WheelView;
...
public class DialogWheelYearMonthDay extends BaseDialog {
    ...
    private String time[] = new String[]{"上午", "下午"};
    ...
    public DialogWheelYearMonthDay(Context mContext, TextView tvTime) {
        super(mContext);
        // TODO Auto-generated constructor stub
        this.mContext = mContext;
        build();
    ...
    public void settiemType(Boolean isTrue) {
        if (isTrue) {
    ...
    private void build() {
        ...
        // mTimeView
        mTimeView = dialogView1
                .findViewById(R.id.wheelView_tiem);
        mTimeView.setBackgroundResource(R.drawable.transparent_bg);
        mTimeView.setWheelBackground(R.drawable.transparent_bg);
        mTimeView.setWheelForeground(R.drawable.wheel_val_holo);
        mTimeView.setShadowColor(0xFFDADCDB, 0x88DADCDB, 0x00DADCDB);
        mTimeView.setViewAdapter(new DateArrayAdapter(mContext, time, curMonth));
        mTimeView.setCurrentItem(curMonth);
        mTimeView.addChangingListener(listener);
    ...
    public String getSelectorTime() {
        return getTime()[getTimeView().getCurrentItem()];
    }
    ...
    private void updateDays(WheelView year, WheelView month, WheelView day) {
        ...
        int maxDays = TimeTool.getDaysByYearMonth(beginYear + year.getCurrentItem(), month.getCurrentItem() + 1);
