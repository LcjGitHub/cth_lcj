package com.chetuhui.lcj.chezhubao_x.view.tabview;
...
public class CustomTabViewBottom extends LinearLayout implements View.OnClickListener{
    ...
    public CustomTabViewBottom(Context context) {
        super(context);
        init();
    }

    public CustomTabViewBottom(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public CustomTabViewBottom(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public CustomTabViewBottom(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public void addTab(Tab tab){
        View view = LayoutInflater.from(getContext()).inflate(R.layout.custom_tab_item_bottom_layout,null);
