...
public class MrDjzFragment extends Fragment {
...
private ImageView iv_amc_sqt;
    ...
    int num=1;
    private MyHandler mHandler =new MyHandler(MrDjzFragment.this);
    private static class MyHandler extends Handler {
            private WeakReference<MrDjzFragment> activityWeakReference;

            public MyHandler(MrDjzFragment activity) {
                activityWeakReference = new WeakReference<MrDjzFragment>(activity);
            }

            @Override
            public void handleMessage(Message msg) {
                MrDjzFragment activity = activityWeakReference.get();
                if (activity != null) {
    ...
    public static MrDjzFragment newInstance() {
        MrDjzFragment fragment = new MrDjzFragment();
        return fragment;
    }
    ...
    private void getN_applicationRecord() {
        ...
        OkGo.<String>get(NetData.N_applicationRecord+"?type=3")
                .tag(this)
