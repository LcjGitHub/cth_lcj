...
public class MmhYsxFragment extends Fragment {
...
private ImageView iv_amc_sqt;
    ...
    int num=1;
    private MyHandler mHandler=new MyHandler(MmhYsxFragment.this);
    private static class MyHandler extends Handler {
            private WeakReference<MmhYsxFragment> activityWeakReference;

            public MyHandler(MmhYsxFragment activity) {
                activityWeakReference = new WeakReference<MmhYsxFragment>(activity);
            }

            @Override
            public void handleMessage(Message msg) {
                MmhYsxFragment activity = activityWeakReference.get();
                if (activity != null) {
    ...
    public static MmhYsxFragment newInstance() {
        MmhYsxFragment fragment = new MmhYsxFragment();
        return fragment;
    }
    ...
    private void getN_mutualAidEvent(String num,String code) {
        ...
        OkGo.<String>get(NetData.N_findMyMutualbills+"?pageSize=10&pageNum="+num+"&type=4&carNum="+code)
                .tag(this)
