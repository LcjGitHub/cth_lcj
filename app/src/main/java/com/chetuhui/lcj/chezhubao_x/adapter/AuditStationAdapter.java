...
public class AuditStationAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    Context        mContext;
    LayoutInflater mInflater;
    List<AuditStationBean.DataBean>   mDatas;
    ...
    public AuditStationAdapter(Context context, List<AuditStationBean.DataBean> datas) {
        mContext = context;
...
//            itemViewHolder.mTvContent.setText(str);
    ...
    public class ItemViewHolder extends RecyclerView.ViewHolder {
        ...
        public ItemViewHolder(View itemView) {
            ...
            cb_item_as=itemView.findViewById(R.id.cb_item_as);
    ...
    public void AddHeaderItem(List<AuditStationBean.DataBean> items) {
        mDatas.addAll(0, items);
        notifyDataSetChanged();
    }

    public void AddFooterItem(List<AuditStationBean.DataBean> items) {
        mDatas.addAll(items);
        notifyDataSetChanged();
    }
