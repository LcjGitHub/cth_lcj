...
public class MrDqrFragment extends Fragment {
...
private ImageView iv_amc_sqt;
    ...
    int num=1;
    private MyHandler mHandler =new MyHandler(MrDqrFragment.this);

        private static class MyHandler extends Handler {
                private WeakReference<MrDqrFragment> activityWeakReference;

                public MyHandler(MrDqrFragment activity) {
                    activityWeakReference = new WeakReference<MrDqrFragment>(activity);
                }

                @Override
                public void handleMessage(Message msg) {
                    MrDqrFragment activity = activityWeakReference.get();
                    if (activity != null) {
    ...
    public static MrDqrFragment newInstance() {
        MrDqrFragment fragment = new MrDqrFragment();
        return fragment;
    }
    ...
    private void getN_applicationRecord() {
        ...
        OkGo.<String>get(NetData.N_applicationRecord+"?type=2")
                .tag(this)
