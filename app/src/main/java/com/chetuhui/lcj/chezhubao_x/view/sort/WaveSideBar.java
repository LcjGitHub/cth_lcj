...
//        if (attrs != null) {
//            TypedArray a = getAppContext().obtainStyledAttributes(attrs, R.styleable.waveSideBar);
...
//    }
 private void init(Context context, AttributeSet attrs) {
    ...
    mTextColor = Color.parseColor("#13d2be");
    mWaveColor = Color.parseColor("#66CDAA");
    ...
    mHintTextSize = context.getResources().getDimensionPixelSize(R.dimen.sp_32);
    ...
    if (attrs != null) {
        ...
        mHintTextSize = a.getDimensionPixelSize(R.styleable.WaveSideBarView_sidebarLargeTextSize, mHintTextSize);
        mWaveColor = a.getColor(R.styleable.WaveSideBarView_sidebarBackgroundColor, mWaveColor);
        mRadius = a.getInt(R.styleable.WaveSideBarView_sidebarRadius, context.getResources().getDimensionPixelSize(R.dimen.sp_20));
        mCircleRadius = a.getInt(R.styleable.WaveSideBarView_sidebarBallRadius, context.getResources().getDimensionPixelSize(R.dimen.sp_24));
        a.recycle();
    }
