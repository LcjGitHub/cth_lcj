    ...
    private void initView() {
        ...
        mEtChangepwPassword1.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                if (!DataTool.isNullString(s.toString()) && mIvChangepwCleanPassword1.getVisibility() == View.GONE) {
        ...
        mEtLchangepwPassword2.addTextChangedListener(new TextWatcher() {
            ...
            @Override
            public void afterTextChanged(Editable s) {
                if (!DataTool.isNullString(s.toString()) && mIvChangepwCleanPassword2.getVisibility() == View.GONE) {
                    ...
                    public void onSuccess(com.lzy.okgo.model.Response<String> response) {
                        ...
                        try {
                            ...
                            if (code==0){
                                ...
                                ActivityTool.finishAllActivity();
                                SPTool.remove(ChangePasswordActivity.this,"token");
