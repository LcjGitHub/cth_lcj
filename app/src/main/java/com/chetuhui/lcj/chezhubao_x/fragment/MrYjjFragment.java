...
public class MrYjjFragment extends Fragment {
...
private ImageView iv_amc_sqt;
    ...
    int num=1;
    private  MyHandler mHandler=new MyHandler(MrYjjFragment.this);
    private static class MyHandler extends Handler {
            private WeakReference<MrYjjFragment> activityWeakReference;

            public MyHandler(MrYjjFragment activity) {
                activityWeakReference = new WeakReference<MrYjjFragment>(activity);
            }

            @Override
            public void handleMessage(Message msg) {
                MrYjjFragment activity = activityWeakReference.get();
                if (activity != null) {
    ...
    public static MrYjjFragment newInstance() {
        MrYjjFragment fragment = new MrYjjFragment();
        return fragment;
    }
    ...
    private void getN_applicationRecord() {
        ...
        OkGo.<String>get(NetData.N_applicationRecord+"?type=4")
                .tag(this)
