...
public class MmhDsxFragment extends Fragment {

private ImageView iv_amc_sqt;
    private View view;
    private RecyclerView mRvGsz;
    private SwipeRefreshLayout mSlGsz;
    private List<MmhBean.DataBean> mBeanList=new ArrayList<>();
    private MmhAdapter mAdapter;
    private LinearLayoutManager mLinearLayoutManager;
    private  boolean issoll=true;
    int num=1;
    private MyHandler mHandler =new MyHandler(MmhDsxFragment.this);
    private static class MyHandler extends Handler {
            private WeakReference<MmhDsxFragment> activityWeakReference;

            public MyHandler(MmhDsxFragment activity) {
                activityWeakReference = new WeakReference<MmhDsxFragment>(activity);
            }

            @Override
            public void handleMessage(Message msg) {
                MmhDsxFragment activity = activityWeakReference.get();
                if (activity != null) {
    ...
    public static MmhDsxFragment newInstance() {
        MmhDsxFragment fragment = new MmhDsxFragment();
        return fragment;
    }
    ...
    private void getN_mutualAidEvent(String num,String code) {
        ...
        OkGo.<String>get(NetData.N_findMyMutualbills+"?pageSize=10&pageNum="+num+"&type=3&carNum="+code)
                .tag(this)
    ...
    private void getfindUserAllByPage_more(String num,String code) {
...
//
    ...
    private void initRecylerView() {
        ...
        mAdapter = new MmhAdapter(getContext(),mBeanList);
