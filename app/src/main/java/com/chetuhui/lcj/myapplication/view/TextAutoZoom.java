 ...
 * @author vondear
 */
public class TextAutoZoom extends android.support.v7.widget.AppCompatEditText {
    ...
    public TextAutoZoom(final Context context) {
        this(context, null, 0);
    }

    public TextAutoZoom(final Context context, final AttributeSet attrs) {
    ...
    public static void setNormalization(final Activity a, View rootView, final TextAutoZoom aText) {

        // if the view is not instance of AutoFitEditText
        // i.e. if the user taps outside of the box
        if (!(rootView instanceof TextAutoZoom)) {
