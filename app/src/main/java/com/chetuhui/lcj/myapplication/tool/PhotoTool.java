...
import static com.chetuhui.lcj.myapplication.tool.FileTool.getDataColumn;
import static com.chetuhui.lcj.myapplication.tool.FileTool.isDownloadsDocument;
import static com.chetuhui.lcj.myapplication.tool.FileTool.isExternalStorageDocument;
import static com.chetuhui.lcj.myapplication.tool.FileTool.isGooglePhotosUri;
import static com.chetuhui.lcj.myapplication.tool.FileTool.isMediaDocument;
...
public class PhotoTool {
    ...
    public static Uri createImagePathUri(final Context context) {
        ...
        if (ContextCompat.checkSelfPermission(context, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            ...
            BaseToast.error("请先获取写入SDCard权限");
        } else {
