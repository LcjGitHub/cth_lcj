...
import com.chetuhui.lcj.myapplication.adapter.AdapterCardViewModelPicture;
import com.chetuhui.lcj.myapplication.model.ModelPicture;
import com.chetuhui.lcj.myapplication.tool.IntentTool;
import com.chetuhui.lcj.myapplication.tool.VibrateTool;
import com.chetuhui.lcj.myapplication.view.BaseToast;
import com.chetuhui.lcj.myapplication.view.cardstack.RxCardStackView;
...
public class DialogTool {
     ...
     */
    @SuppressLint("StaticFieldLeak")
    private static DialogLoading mDialogLoad;
    ...
    public static void loadingHttp(Context context) {
        ...
        mDialogLoading = new DialogLoading(context);
    ...
    public static void loading(Context context) {
        ...
        mDialogLoad = new DialogLoading(context);
    ...
    public static void initDialogSurePermission(final Context mContext, String str) {
        ...
        rxDialogSure.setSureListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                rxDialogSure.cancel();
                mContext.startActivity(IntentTool.getAppDetailsSettingsIntent(mContext));
            }
        });
        rxDialogSure.show();
    }
    ...
    public static void initDialogExport(final Context mContext, final String hint) {
        ...
        final DialogSureCancel mDialogExport = new DialogSureCancel(mContext, R.style.PushUpInDialogThem);
    ...
    public static void initDialogShowPicture(Context mContext, final List<ModelPicture> modelList) {
        final BaseDialog mDialogShowPicture = new BaseDialog(mContext);
