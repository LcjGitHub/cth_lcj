package com.chetuhui.lcj.myapplication.view.popupwindows;
...
import com.chetuhui.lcj.myapplication.model.ActionItem;
import com.chetuhui.lcj.myapplication.tool.DeviceTool;
...
public class PopupSingleView extends PopupWindow {
    ...
    public PopupSingleView(Context context) {
        // 设置布局的参数
        this(context, LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
    }

    public PopupSingleView(Context context, int width, int height) {
    ...
    public PopupSingleView(Context context, int width, int height, int layout) {
        this.mContext = context;
    ...
    public void show(View view) {
        ...
        // 显示弹窗的位置
        showAtLocation(view, popupGravity, mScreenWidth - LIST_PADDING - (getWidth() / 2), mRect.bottom + ImageTool.dp2px(7.5f));
    }
