...
import com.chetuhui.lcj.myapplication.tool.DataTool;
...
//		canvas.drawRect(0, 0, getWidth(), getWidth(), paint);// 正方形
        ...
        //右边最大值
        canvas.drawText(DataTool.format2Decimals(getProgress() + ""), (centre + 90) - moneyPaint.measureText(DataTool.format2Decimals(getProgress() + "")) / 2 - 15, centre + 105, moneyPaint);
        //}
        //右边最大值
        canvas.drawText("元", (centre + 90) + moneyPaint.measureText(DataTool.format2Decimals(getProgress() + "")) / 2 - 10, centre + 105, moneyDPaint);
        //根据进度画圆弧
